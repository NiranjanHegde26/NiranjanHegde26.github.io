...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-successfully-defended-my-master-thesis-titled-individual-differences-of-inhibition-control-in-bilingual-sentence-processing-a-self-paced-reading-approach-tada",
          title: 'Successfully defended my Master Thesis titled Individual Differences of Inhibition Control in Bilingual...',
          description: "",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-acquisition-of-spoken-language",
          title: 'Acquisition of Spoken Language',
          description: "",
          section: "Projects",handler: () => {
              window.location.href = "/projects/language_acquisition/";
            },},{id: "projects-language-evolution",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-nlp-for-psycholinguistic-research",
          title: 'NLP For Psycholinguistic Research',
          description: "",
          section: "Projects",handler: () => {
              window.location.href = "/projects/nlp_for_psycholinguistics/";
            },},{id: "projects-ukrainian-as-a-bridge-language",
          title: 'Ukrainian As a Bridge Language',
          description: "",
          section: "Projects",handler: () => {
              window.location.href = "/projects/receptive_multilingualism/";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%62%73%6E%69%72%61%6E%6A%61%6E%61%68%65%67%64%65@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/NiranjanHegde26", "_blank");
        },
      },{
        id: 'social-instagram',
        title: 'Instagram',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/niranjana-hegde-b-s-201916183", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=81ZOT6UAAAAJ", "_blank");
        },
      },{
        id: 'social-unsplash',
        title: 'Unsplash',
        section: 'Socials',
        handler: () => {
          window.open("https://unsplash.com/@bsniru", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/bsniru", "_blank");
        },
      },{
      id: 'light-theme',
